        ...
        <div class="col-sm-12">
            <section class="panel">
                ...
                <div class="panel-body">
                    <form role="form" action="{{route('admin.restaurant.table.store')}}" method="POST">
                        @csrf
                        <div class="form-group">
                            <label for="restaurant_table_number"> Restaurant Table Number</label>
                            <input value="{{old('restaurant_table_number')}}" name="restaurant_table_number" type="number" class="form-control" id="restaurant_table_number" placeholder="restaurant table number">
                        ...
                        <div class="form-group">
                            ...
                            <input value="{{old('restaurant_table_name')}}" name="restaurant_table_name" type="text" class="form-control" id="restaurant_table_name" placeholder="restaurant table name">
                        ...
                        <div class="form-group">
                            ...
                            <input value="{{old('restaurant_table_seat')}}" name="restaurant_table_seat" type="number" class="form-control" id="restaurant_table_seat" placeholder="restaurant table seat">
