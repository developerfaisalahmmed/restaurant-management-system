...
@section('title', 'Restaurant Food Category Create|')
        ...
        <div class="col-sm-12">
            <section class="panel">
                <header class="panel-heading">
                    Total Restaurant Food Category
                    <span class="tools pull-right">
                <a href="{{route('admin.restaurant.table')}}" class="fa fa-list"> Category Lists </a>
                ...
                <div class="panel-body">
                    <form role="form" action="{{route('admin.restaurant.food.category.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf

                        <div class="form-group">
                            <label for="restaurant_food_category_name"> Restaurant Food Category Name</label>
                            <input value="{{old('restaurant_food_category_name')}}" name="restaurant_food_category_name" type="text" class="form-control" id="restaurant_food_category_name" placeholder="restaurant table name">
